...
git clone [https://github.com/vid0326/your-portfolio-repo.git](https://github.com/vid0326/your-portfolio-repo.git)
...
Push your backend code (including vercel.json) to a GitHub repository.

Import the repository into Vercel.

Set the environment variables in the Vercel project settings (especially MONGO_URI and FRONTEND_URL).

Deploy.

Frontend Deployment:

Push your frontend code to a separate GitHub repository.

Import the repository into Vercel. Vercel will auto-detect it as a Create React App.

Set the REACT_APP_API_URL environment variable to your live backend URL.
...
https://me-playground.onrender.com/api/health

Checks the health status of the API.

GET

https://me-playground.onrender.com/api/profile

Retrieves the main user profile data.

POST

https://me-playground.onrender.com/api/profile

Creates or updates the main profile (auth req).

GET

https://me-playground.onrender.com/api/projects

Gets a paginated list of all projects.

GET

https://me-playground.onrender.com/api/projects?skill=...

Filters projects by a specific skill.

GET

https://me-playground.onrender.com/api/skills/top

Gets the most frequently used skills.

GET

https://me-playground.onrender.com/api/skills/search?q=...

Searches for skills by name (for autocomplete).
